...
public class LightPrefUtil {
    private static final String TAG = "LightPrefUtil";
    ...
    public static void setLocalPassword(Context context, @NonNull String mac, int psw) {
        ...
        editor.putInt(mac + "-" + ConstVal.KEY_PASSWORD, psw);
        editor.apply();
    }

    public static int getLocalPassword(Context context, @NonNull String mac) {
        SharedPreferences defaultSet = PreferenceManager.getDefaultSharedPreferences(context);
        final int password = defaultSet.getInt(mac + "-" + ConstVal.KEY_PASSWORD, -1);
        return password;
    }

    public static void removeLocalPassword(Context context, @NonNull String mac) {
        SharedPreferences defaultSet = PreferenceManager.getDefaultSharedPreferences(context);
        SharedPreferences.Editor editor = defaultSet.edit();
        editor.remove(mac + "-" + ConstVal.KEY_PASSWORD);
        editor.apply();
    }
