...
/**
 * 蓝牙设备基础类 Created by Administrator on 2016/10/20.
 */
...
public class BaseDevice {
    ...
    public BaseDevice(DevicePrefer devicePrefer) {
        mDevicePrefer = devicePrefer;
    }

    public BaseDevice(byte majorVersion, byte minorVersion, DevicePrefer devicePrefer, DeviceTime deviceTime) {
